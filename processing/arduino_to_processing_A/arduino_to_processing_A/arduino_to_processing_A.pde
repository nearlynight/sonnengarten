...
void draw()
{
  //if ( myPort.available() > 0) {  
    ...
    if (val_3 == 49) {
      OscMessage m = new OscMessage("/touch/9");
      int a = 9;
      m.add(a);
      oscP5.send(m,myRemoteLocation);  
      println(time + " 9 touch");
      output.println(date + time + " 9 touched");
    }
    if (val_3 == 50) {
      OscMessage m = new OscMessage("/touch/10");
      int a = 10;
      m.add(a);
      oscP5.send(m,myRemoteLocation);  
      println(time + " 10 touch");
      output.println(date + time + " 10 touched");
    }
    if (val_3 == 51) {
      OscMessage m = new OscMessage("/touch/11");
      int a = 11;
      m.add(a);
      oscP5.send(m,myRemoteLocation);  
      println(time + " 11 touch");
      output.println(date + time + " 11 touched");
    }
    if (val_3 == 52) {
      OscMessage m = new OscMessage("/touch/12");
      int a = 12;
      m.add(a);
      oscP5.send(m,myRemoteLocation);  
      println(time + " 12 touch");
      output.println(date + time + " 12 touched");
    }
    ...
    if (val_3 == 97 ) {
      ...
      m.add(e);
      oscP5.send(m,myRemoteLocation); 
      println(time + " 9 released");
      output.println(date + time + " 9 released");
    }
    if (val_3 == 98 ) {
      OscMessage m = new OscMessage("/touch/10");
      int e = 10;
      m.add(e);
      oscP5.send(m,myRemoteLocation); 
      println(time + " 10 released");
      output.println(date + time + " 10 released");
    }
    if (val_3 == 99 ) {
      OscMessage m = new OscMessage("/touch/11");
      int e = 11;
      m.add(e);
      oscP5.send(m,myRemoteLocation); 
      println(time + " 11 released");
      output.println(date + time + " 11 released");
    }
    if (val_3 == 100 ) {
      OscMessage m = new OscMessage("/touch/12");
      int e = 12;
      m.add(e);
      oscP5.send(m,myRemoteLocation); 
      println(time + " 12 released");
      output.println(date + time + " 12 released");
    }
  //if (val != -1 ){
